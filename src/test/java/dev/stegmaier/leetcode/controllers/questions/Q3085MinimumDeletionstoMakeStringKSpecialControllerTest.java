...
class Q3085MinimumDeletionstoMakeStringKSpecialControllerTest {
    ...
    @MockitoBean
    private Q3085MinimumDeletionService minimumDeletionService;
    ...
    void testQuestion3085PageLoads() throws Exception {
        mockMvc
                ...
                .andExpect(
                        content().string(org.hamcrest.Matchers.containsString("Minimum Deletions To Make String K-Special")));
    }
    ...
    void testHandleQuestion3085Input() throws Exception {
        ...
        mockMvc
                .perform(post("/questions/3085-Minimum-Deletions-To-Make-String-K-Special").param("expression", "aaaabbbccc").param("kValue", "12"))
                .andExpect(status().isOk())
    ...
    void testHandleQuestion3085Input_InvalidExpression() throws Exception {
        ...
        mockMvc
                .perform(
                        post("/questions/3085-Minimum-Deletions-To-Make-String-K-Special").param("expression", "invalid").param("kValue", "12"))
                .andExpect(status().isOk())
                .andExpect(
                        model().attribute("result", "Invalid input. Please enter a valid input."))
                .andExpect(view().name("questions/3085-Minimum-Deletions-To-Make-String-K-Special"));
    }
}