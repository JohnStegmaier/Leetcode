...
public class Q3085MinimumDeletionstoMakeStringKSpecialController {
  ...
  private static final Logger log = getLogger(Q3085MinimumDeletionstoMakeStringKSpecialController.class);
  ...
  public String question3085Page(HttpServletRequest request, HttpServletResponse response) {
    ...
    return "questions/3085-Minimum-Deletions-To-Make-String-K-Special"; // Refers to addition.html template
  }
  ...
  public String handleQuestion3085Input(
    ...
    try {
      int result =
              q3085MinimumDeletionService.getMinimumDeletions(expression, kValue); // Using the injected MathService
